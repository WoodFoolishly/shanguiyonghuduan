...
import com.example.shangui.shangui.ShanGuiApplication;
import com.example.shangui.shangui.adapter.EmotionGridViewAdapter;
import com.example.shangui.shangui.adapter.EmotionPagerAdapter;
import com.example.shangui.shangui.base.BaseFragment;
import com.example.shangui.shangui.util.EmotionUtils;
import com.example.shangui.shangui.util.GlobalOnItemClickManagerUtils;
import com.example.shangui.shangui.util.Utils;
import com.example.shangui.shangui.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = ShanGuiApplication.screenWidth;
        // item的间距
