...
public class ChatFunctionFragment extends BaseFragment {
    ...
    protected void initView() {
        chatFunctionPhoto.setOnClickListener((View.OnClickListener) getActivity());
        chatFunctionPhotograph.setOnClickListener((View.OnClickListener) getActivity());
    }
    ...
    @OnClick({R.id.chat_function_photograph, R.id.chat_function_photo})
